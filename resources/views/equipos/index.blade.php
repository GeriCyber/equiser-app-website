...
@section('breadcrumb_url', '/equipos')
    ...
    <div class="main" id="main">
    	<div class="container-fluid my-5">
            <h1 class="f-size-22 pt-4 text-center equiser-color wow fadeInUp" data-wow-delay="0s">{{__('msg.available-equipments')}} <b>{{Session::get('country')=='usa' ? strtoupper(Session::get('country')) : ucfirst(Session::get('country'))}}</b></h1><hr class="divider" width="5%">
