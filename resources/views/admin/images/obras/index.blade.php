@extends('layouts.app')
@section('page-title', 'Imágenes de '.$obra->name)
@section('content')
@section('title', 'Imágenes de '.$obra->name)
      ...
      <form class="mb-5" method="POST" action="" enctype="multipart/form-data" autocomplete="off">
        ...
        <div class="row">
          <div class="col-md-12 d-flex justify-content-lg-end justify-content-xl-end">
              <button type="submit" class="btn btn-equiser-4 mr-3 btn-primary btn-action">Agregar</button>
              <a class="btn btn-equiser btn-primary btn-action" href="{{url('/admin/obras')}}">Obras</a>
          </div>
        </div>
            ...
            <div class="col-12 col-md-6 col-lg-4 col-xl-4 mt-4">
              <div class="panel panel-default">
                <div class="panel-body text-center">
                  ...
                  <a href="{{ url('/admin/obras/imagenes/'.$obra->id.'/destacar/'.$image->id) }}" class="featured-icon btn btn-equiser-4"><i class="fa fa-star"></i></a>
                </div>
              </div>
            </div> <!-- col-6 / end -->
            @endforeach
