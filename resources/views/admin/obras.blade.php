@extends('layouts.app')
@section('page-title', 'Administración de Obras')
@section('content')
...
@section('breadcrumb_url', '/admin/dashboard')
    ...
    <div class="container py-5">
    	...
    	<div class="table-responsive">
    		<button type="button" class="btn btn-equiser-4 btn-primary btn-action btn-lg float-xl-right float-lg-right" name="create_record" id="create_record">Añadir Obra</button>
	    	<table id="obras" class="display nowrap table table-hover table-bordered table-striped" style="width: 100%">
	        <thead class="thead-dark">
	        <tr>
	            <th class="font-weight-bold">Id</th>
	            <th class="font-weight-bold">Nombre</th>
	            <th class="font-weight-bold">Proyecto</th>
	            <th class="font-weight-bold" width="180">Equipos</th>
	 ...
	 <div class="modal-dialog modal-lg">
	  <div class="modal-content">
	   <div class="modal-header bg-equiser">
	        <h4 class="modal-title text-left font-weight-bold text-white">Agregar Obra</h4>
	    </div>
            ...
            <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="pills-spanish" role="tabpanel" aria-labelledby="pills-spanish-tab">
                <div class="form-group">
                  <label class="control-label col-md-12 equiser-color font-weight-bold" >Nombre del Proyecto: </label>
                  <div class="col-md-12">
                   <input minlength="4" maxlength="190" type="text" placeholder="Escribe el nombre del proyecto" name="Nombre" id="name" class="form-control" />
                  </div>
                 </div>
                 <div class="form-group">
                  <label class="control-label col-md-12 equiser-color font-weight-bold" >Subtitulo del Proyecto: </label>
                  <div class="col-md-12">
                   <input minlength="4" maxlength="190" type="text" placeholder="Escribe el subtitulo del proyecto" name="Subtitulo" id="subtitle" class="form-control" />
                  </div>
                 </div>
                 <div class="form-group">
                  <label class="control-label col-md-12 equiser-color font-weight-bold">Descripción de Proyecto: </label>
                  <div class="col-md-12">
                    <textarea minlength="4" maxlength="1500" placeholder="Escribe una descripción del proyecto" class="form-control" name="Proyecto" id="project" rows="5"></textarea>
                  </div>
                </div>
              </div>
              <div class="tab-pane fade" id="pills-english" role="tabpanel" aria-labelledby="pills-english-tab">
                <div class="form-group">
                  <label class="control-label col-md-12 equiser-color font-weight-bold" >Nombre del Proyecto: </label>
                  <div class="col-md-12">
                   <input minlength="4" maxlength="190" type="text" placeholder="Escribe el nombre en ingles del proyecto" name="Nombre_ingles" id="name_en" class="form-control" />
                  </div>
                 </div>
                 <div class="form-group">
                  <label class="control-label col-md-12 equiser-color font-weight-bold" >Subtitulo del Proyecto: </label>
                  <div class="col-md-12">
                   <input minlength="4" maxlength="190" type="text" placeholder="Escribe el subtitulo en ingles del proyecto" name="Subtitulo_ingles" id="subtitle_en" class="form-control" />
                  </div>
                 </div>
                 <div class="form-group">
                  <label class="control-label col-md-12 equiser-color font-weight-bold">Descripción de Proyecto: </label>
                  <div class="col-md-12">
                    <textarea minlength="4" maxlength="1500" placeholder="Escribe una descripción en ingles del proyecto" class="form-control" name="Proyecto_ingles" id="project_en" rows="5"></textarea>
                  </div>
                </div>
              </div>
            </div>
	           ...
	           <div class="form-group">
	            <label class="control-label col-md-12 equiser-color font-weight-bold">Equipos: </label>
	            <div class="col-md-12">
	             <input type="text" minlength="4" maxlength="190" placeholder="Ingresa los equipos utilizados en la obra" name="Equipos" id="equipos" class="form-control" />
	            </div>
	           </div>
             <div class="form-group">
              ...
              <div class="col-md-12">
	           ...
	           <div class="form-group" align="center">
	            ...
	            <input type="submit" name="action_button" id="action_button" class="btn btn-equiser-4 btn-action float-left ml-3" value="Agregar" />
	           </div>
	         </form>
	        </div>
	...
	<div id="showModal" class="modal fade" role="dialog">
		<div class="modal-dialog modal-lg">
		  <div class="modal-content">
		   <div class="modal-header bg-equiser">
		        <h4 class="modal-title text-left font-weight-bold text-white">Obra</h4>
		    </div>
		    <div class="modal-body my-3">
		        <h2 class="font-weight-bold equiser-color mb-2">Nombre del proyecto</h2>
		        <p id="name-show"></p> <br> <br>
            <h2 class="font-weight-bold equiser-color mb-2">Subtitulo del proyecto</h2>
            <p id="subtitle-show"></p> <br> <br>
		        <h2 class="font-weight-bold equiser-color mb-2">Descripción del proyecto</h2>
		        <p id="project-show"></p> <br> <br>
		        <h2 class="font-weight-bold equiser-color mb-2">Equipos</h2>
		        <p id="equipos-show"></p> <br><br>
		     </div>
		     <div class="modal-footer">
	...
	<div id="confirmModal" class="modal fade" role="dialog">
	    <div class="modal-dialog modal-dialog-centered">
	        <div class="modal-content">
	            <div class="modal-header bg-equiser">
	                <h2 class="modal-title text-white font-weight-bold">Borrar Obra</h2>
	            </div>
	            <div class="modal-body">
	                <h4 align="center" style="margin:0;">Estas seguro que quieres eliminar la obra seleccioanda?</h4>
	            </div>
	            <div class="modal-footer">
	             <button type="button" name="ok_button" id="ok_button" class="btn btn-danger btn-equiser-4 btn-action">Borrar</button>
...
@push('datatable')
    ...
    <script type="text/javascript">
        $(function() {
            $('#obras').DataTable({
                ...
                "language": {
                    "lengthMenu": "Mostrar _MENU_ obras",
                    "zeroRecords": "Sin resultados.",
                    "info": "Página _PAGE_ de _PAGES_",
                    "infoEmpty": "No hay obras cargadas.",
                    "search":         "Buscar Obra:",
        ...
        $('#create_record').click(function(){
          $('.modal-title').text("Argregar Obra");
    ...
    $(document).on('click', '.edit', function(){
      ...
      $.ajax({
       ...
       success:function(html) {
        ...
        $('#project_en').val(html.data.project_en);
        $('#equipos').val(html.data.equipos);
    ...
    $(document).on('click', '.showObra', function() {
        var id = $(this).attr('id');
        $.ajax({
           url:"/admin/obras/show/"+id,
           dataType:"json",
           success:function(html) {
                $('#name-show').text(html.data.name);
                $('#subtitle-show').text(html.data.subtitle);
                $('#project-show').text(html.data.project);
                $('#equipos-show').html(html.data.equipos);
